        ...
        <div className="mt-5">

            {
                showData === true ? (
                        ...
                        <div className="card mb-3 mx-auto bg-dark text-light">
                            <div className="row g-0">
                                <div className="col-md-4">
                                    ...
                                    <img src="https://images.pexels.com/photos/7008308/pexels-photo-7008308.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" className="img-fluid rounded-start" alt="..."/>
                                </div>
                    ...
                    <h2 className="warning">No se encontraron datos</h2>
                )
            }
